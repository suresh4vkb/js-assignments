...
## Javascript Assignments  [![Build Status](https://travis-ci.org/suresh4vkb/js-assignments.svg?branch=master)](https://travis-ci.org/suresh4vkb/js-assignments)
...
* Run `git clone https://github.com/suresh4vkb/js-assignments.git` from command line to download the repo.
...
* Edit local README.md file and update all links (just replace all occurrences of `'suresh4vkb'` with your account name).
...
```
* Open https://github.com/suresh4vkb/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/suresh4vkb/js-assignments/builds).
